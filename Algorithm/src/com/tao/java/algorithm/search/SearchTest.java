...
import static com.tao.java.algorithm.search.FibonacciSearch.fibonacciSearch;
import static com.tao.java.algorithm.search.InsertSearch.insertSearch;
import static com.tao.java.algorithm.sort.QuickSort.quickSort;
...
//            arr[i] = i;
        ...
        start = System.currentTimeMillis();
        result = LinearSearch.linearSearch(arr, target);
