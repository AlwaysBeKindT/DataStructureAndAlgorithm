...
import static com.tao.java.algorithm.sort.BasicSort.basicSort;
import static com.tao.java.algorithm.sort.InsertSort.insertSort;
import static com.tao.java.algorithm.sort.ShellSort.shellSort;
...
public class SortTest {
    ...
    public void test() {
        ...
        QuickSort.quickSort(arr1, 0, num - 1);
        outPrint("快速排序：");

        start = System.currentTimeMillis();
        MergeSort.mergeSort(arr2, 0, num - 1);
        outPrint("归并排序：");
